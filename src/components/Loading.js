...
const Loading = (props) => {
    ...
    return (
        <div className={`fixed left-0 top-0 h-screen w-screen justify-center items-center overflow-hidden z-10 ${isLoading ? 'loading-anim-parent-in' : 'loading-anim-parent-out'}`}>
