...
const DetailForm = () => {
    ...
    const createQuestionHandler = (e) => {
        ...
        axiosAuth(token)
            .post(endpoint_created_question, {
                name: question_name,
    ...
    const handleDeleteQuestion = (id) => {
        ...
        axiosAuth(token)
            .delete(endpoint_deleteQuestion)
            .then((response) => {
                getFormApi();
            })
            .catch((error) => {
    ...
    if (status === 200 && current_user.email === data.creator.email) {
                                ...
                                <div className='min-w-[50%]'>
                                    ...
                                    <div className='flex gap-8 items-center'>
                                        ...
                                        <div className='flex justify-center items-center gap-3'>
                                            ...
                                            {data.allowed_domains.join(",") !== "" ? (
                                                data.allowed_domains.map((items) => <span className='bg-slate-200 rounded-xl py-1 px-2 text-sm'>{items}</span>)
                                            ) : (
                                    ...
                                    <div className='mt-8'>
                                        ...
                                        <div className='flex flex-col gap-2'>
                                            {data.question.length > 0
                                                ? data.question.map((items) => (
                                                      <div className='border-2 rounded-xl p-4'>
                                                          <div className='flex justify-between items-center'>
                                                              <h2 className='text-xl'>
                                                                  {items.name}
                                                                  {items.is_required === 1 ? <span className='text-red-500 font-bold'> *</span> : null}
                                                              </h2>
                                                              <div className='flex gap-3 items-center'>
                                                                  <Icon
                                                                      icon='mi:delete'
                                                                      width='30'
                                                                      className='text-red-300 hover:text-red-500 transition-all cursor-pointer'
                                                                      onClick={() => handleDeleteQuestion(items.id)}
                                                                  />
                                                              </div>
                                                          </div>
                                                          <div className='mt-3 flex'>
                                                              {items.choice_type === "short answer" ? (
                                                                  ...
                                                                  <select className='border-2 rounded-xl p-2 mt-2' disabled>
                                                                      ...
                                                                      {items.choices.split(",").map((choices_item) => (
                                                                          <option type='checkbox' className='mr-2' disabled>
                                                                              {choices_item}
                                                                          </option>
                                                                      ))}
                                                                  </select>
                                            ...
                                            {isAdded ? (
                                                <form method='POST' className='border-2 rounded-xl p-4 border-sky-200 flex flex-col gap-2' onSubmit={createQuestionHandler}>
                                                    <div>
                                                        ...
                                                        <input
                                                            type='text'
                                                            name='name'
                                                            className='border-2 p-2 mt-2 rounded-xl w-full focus:border-sky-500 focus:outline-none transition-all'
                                                        ...
                                                        <div className='w-full'>
                                                            ...
                                                            <div className='mt-2 flex items-center'>
                                                                <input
                                                                    ...
                                                                    value='true'
                                                                    name='is_required'
                                                                    className='appearance-none w-5 h-5 border-2 mr-3 rounded-lg checked:bg-sky-400 transition-all duration-300'
                                                                />
                                                    ...
                                                    {choices_type === "dropdown" || choices_type === "multiple choice" || choices_type === "checkboxes" ? (
                                                        <div>
                                                            ...
                                                            <input
                                                                ...
                                                                name='choices'
                                                                className='border-2 p-2 mt-2 rounded-xl w-full focus:border-sky-500 focus:outline-none transition-all'
                                                                placeholder='Add choices, Example: choices1, choices2'
                                                                required
                                                            />
                                                        </div>
                                                    ) : null}
                                                    ...
                                                    <div className='flex justify-between mt-3'>
                                                        <button
                                                            ...
                                                            className='border-2 py-2 px-4 rounded-lg flex items-center gap-2 font-bold text-slate-500 hover:bg-slate-500 hover:text-white transition-all duration-300'>
                                                            <Icon icon='line-md:arrow-small-left' width='20' />
                                                            Cancel
                                                        </button>
                                                        <div className='flex gap-3'>
                                                            <button
                                                                type='reset'
                                                                className='border-2 border-red-200 py-2 px-4 rounded-lg flex items-center gap-2 font-bold text-red-500 hover:bg-red-500 hover:text-white transition-all duration-300'>
                                                                Reset
                                                            </button>
                                                            <button
                                                                type='submit'
                                                                className='border-2 py-2 px-4 bg-sky-400 text-white border-sky-200 rounded-lg flex items-center gap-2 font-bold hover:bg-sky-500 transition-all duration-300'>
                                                                Create
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div
                                                    className='border-2 rounded-xl p-4 flex flex-col justify-center items-center border-sky-200 text-sky-500 gap-2 cursor-pointer hover:bg-sky-500 hover:text-white transition-all'
                                                    onClick={addQuestionHandler}>
                                    ...
                                    <div className='mt-8'>
                                        <h1 className='font-bold text-xl mb-2'>
                                            Response: <span className='text-slate-500'>{response.length}</span>
                                        </h1>
                                        <div className='flex flex-col gap-5'>
                                            {response.length ? (
                                                response.map((itemsResponse) => (
                                                    <div className='border-2 rounded-xl p-4'>
        ...
        return (
            <>
                <section className='ml-52 py-8 px-10 flex justify-center items-center h-screen'>Forbidden</section>
            </>
        );
    } else {
        return (
                                                      ...
                                                      <div className='mt-3 flex'>
                                                          {items.choice_type === "short answer" ? (
                                                              ...
                                                              <select className='border-2 rounded-xl p-2 mt-2' name={`question_${items.id}`}>
                                                                  ...
                                                                  {items.choices.split(",").map((choices_item) => (
                                                                      <option className='mr-2' value={choices_item}>
                                                                          {choices_item}
                                                                      </option>
                                                                  ))}
                                                              </select>
