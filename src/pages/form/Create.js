...
const Create = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axiosAuth(token)
            ...
            .catch((error) => {
                ...
                dom = (
                    <div className='flex justify-center items-center gap-2 bg-red-100 p-2 rounded-lg border-2 border-red-400 text-red-400 font-bold w-1/2'>
    ...
    return (
        <>
            <Helmet>
                <title>Create Form - FormApp</title>
            </Helmet>
                ...
                <form method='POST' className='flex flex-col gap-5 items-center' onSubmit={handleSubmit}>
                    ...
                    <div className='flex gap-5 w-1/2'>
                        <div className='flex flex-col w-1/2'>
                            ...
                            <input
                                type='text'
                                className='border-2 p-2 rounded-lg focus:border-sky-400 focus:outline-none transition-all duration-300'
                                name='name'
                        ...
                        <div className='flex flex-col w-1/2'>
                            <label className='mb-2'>
                                Slug (you can custom for url) <span className='text-red-500 font-bold'>*</span>
                            </label>
                    ...
                    <div className='flex flex-col w-1/2'>
                        <label className='mb-2'>Allowed Email Domains (leave blank to allow all)</label>
                        <input
                            type='text'
                            className='border-2 p-2 rounded-lg focus:border-sky-400 focus:outline-none transition-all duration-300'
                            name='allowed_domains'
                            placeholder='Example: example.com, gmail.id'
                        />
                    </div>
                    ...
                    <div className='flex justify-between w-1/2'>
                        <a href='/' className='border-2 py-2 px-4 rounded-lg flex items-center gap-2 font-bold text-slate-500 hover:bg-slate-500 hover:text-white transition-all duration-300'>
